...
export default async function VendorBookingDetailPage({ params }: VendorBookingDetailPageProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold">{booking.customer.fullName}</h2>
        ...
        <CardContent className="space-y-3">
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{booking.customer.phoneNumber}</p>
            </div>
            <div>
